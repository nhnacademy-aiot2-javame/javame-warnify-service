...
public class WarnifyController {
     ...
     */
    public WarnifyController(List<WarnifyService> serviceList, MemberApiAdaptor memberApiAdaptor) {
    ...
    private List<MemberResponse> getMemberResponseList() {
        ResponseEntity<List<MemberResponse>> responseEntity = memberApiAdaptor.getMemberById();
